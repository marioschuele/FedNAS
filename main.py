...
def add_args(parser):
    ...
    parser.add_argument('--dataset', type=str, default='sidd', metavar='N',
    ...
    parser.add_argument('--client_number', type=int, default=15, metavar='NN',
...
def init_server(args, comm, rank, size, round_num):
    ...
    #logging.info("Length net_dataidx_map:  %s", len(net_dataidx_map[0]))
    #logging.info("#####################")
